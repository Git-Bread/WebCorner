      ...
      <div class="lg:w-1/2 order-1 lg:order-2 py-4">
        ...
        <ul class="space-y-3 mb-6 sm:mb-8 feature-list" aria-label="Workflow customization features">
          <li class="flex items-center">
            <fa :icon="['fas', 'sliders']" class="text-accent-blue mr-3 flex-shrink-0 icon-md" aria-hidden="true" />
            <span>Customize the page just for you</span>
          </li>
          <li class="flex items-center">
            <fa :icon="['fas', 'calendar']" class="text-accent-blue mr-3 flex-shrink-0 icon-md" aria-hidden="true" />
            <span>Your schedules, your planning, your workspace</span>
          </li>
          <li class="flex items-center">
            <fa :icon="['fas', 'palette']" class="text-accent-blue mr-3 flex-shrink-0 icon-md" aria-hidden="true" />
