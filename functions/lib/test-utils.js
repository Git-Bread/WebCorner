...
exports.createExpiredInvites = createExpiredInvites;
exports.checkInvitesExistence = checkInvitesExistence;
 ...
 */
async function createExpiredInvites(count = 3) {
    const inviteIds = [];
 ...
 */
async function checkInvitesExistence(inviteIds) {
    const db = admin.firestore();
    try {
